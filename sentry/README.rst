...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:761ae6434f700b6498946e465d6e4d33cfb23c65c1c7a24583d26723d5848519
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
If you are on Odoo.sh, or you control the environment variables on your
Odoo nodes, you can distinguish between settings for different
environments by inserting the environment in the configuration key. For
example:
...
The value that is inserted in the key is provided by the *ODOO_STAGE*
environment variable which is set on Odoo.sh to either ``production`` or
``staging`` (but you can use any value). A key without environment part
